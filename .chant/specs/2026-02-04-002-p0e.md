...
- [x] Create `src/validators.ts` with reusable validation functions
- [x] Add input validation to all 9 MCP tools
- [x] Implement type checking for all parameters
- [x] Add range validation (e.g., limit 1-30, issue_number > 0)
- [x] Add format validation (e.g., repo must be "owner/repo")
- [x] Validate enum values (e.g., status: pending|ready|completed)
- [x] Return helpful error messages when validation fails
