...
export interface MasteryStatus {
  conceptId: string;
  mastered: boolean;
  depth: "surface" | "intermediate" | "deep"; // Learning depth
...
export const CONCEPT_GRAPH: Record<string, ConceptNode> = {
  ...
  "basic-types": {
    ...
    name: "Basic Types",
    description:
      "Understanding integers, floats, strings, booleans, and type representation in memory",
    difficulty: "beginner",
    prerequisites: [],
  ...
  "control-flow": {
    ...
    name: "Control Flow",
    description:
      "If statements, loops, conditional execution, and control structures",
    difficulty: "beginner",
  ...
  "recursion": {
    ...
    name: "Recursion",
    description:
      "Recursive functions, call stacks, base cases, and recursive problem solving",
  ...
  "memory-management": {
    ...
    description:
      "Stack vs heap, allocation/deallocation, ownership, and memory safety",
    difficulty: "intermediate",
    prerequisites: ["basic-types"],
  ...
  "pointers-references": {
    ...
    description:
      "Pointer arithmetic, dereferencing, reference semantics, and aliasing",
    difficulty: "intermediate",
  ...
  "data-structures": {
    ...
    description:
      "Arrays, linked lists, trees, graphs, hash tables, and collections",
    difficulty: "intermediate",
  ...
  "algorithms": {
    ...
    name: "Algorithms",
    description:
      "Sorting, searching, traversal, and algorithm analysis (Big-O notation)",
    difficulty: "intermediate",
  ...
  "type-systems": {
    ...
    name: "Type Systems",
    description:
      "Static vs dynamic typing, type inference, generics, and type safety",
    difficulty: "intermediate",
    prerequisites: ["basic-types"],
  ...
  "pattern-matching": {
    ...
    description:
      "Destructuring, exhaustiveness checking, and match expressions",
    difficulty: "intermediate",
  ...
  "async-await": {
    ...
    name: "Async/Await",
    description:
      "Asynchronous programming, promises, futures, and non-blocking I/O",
    difficulty: "intermediate",
    prerequisites: ["functions-and-scope"],
  ...
  "concurrency": {
    ...
    name: "Concurrency",
    description:
      "Threads, processes, race conditions, deadlocks, and synchronization primitives",
    difficulty: "advanced",
  ...
  "atomics": {
    ...
    description:
      "Atomic reads/writes, compare-and-swap, memory ordering, and lock-free programming",
    difficulty: "advanced",
  ...
  "locks": {
    ...
    description:
      "Mutexes, semaphores, readers-writer locks, and synchronization strategies",
    difficulty: "advanced",
  ...
  "testing": {
    ...
    name: "Testing",
    description:
      "Unit tests, integration tests, mocks, test-driven development, and coverage",
    difficulty: "intermediate",
    prerequisites: ["functions-and-scope"],
  ...
  "debugging": {
    ...
    name: "Debugging",
    description:
      "Debugging techniques, logging, profiling, and problem diagnosis",
    difficulty: "intermediate",
  ...
  "api-design": {
    ...
    name: "API Design",
    description:
      "Interface design, contracts, versioning, and API compatibility",
    difficulty: "intermediate",
    prerequisites: ["type-systems"],
  ...
  "garbage-collection": {
    ...
    description:
      "GC algorithms, mark-and-sweep, reference counting, and memory pressure",
    difficulty: "advanced",
    prerequisites: ["memory-management"],
    relatedConcepts: ["optimization", "performance-bottleneck"],
  },
  ...
  "race-conditions": {
    ...
    description:
      "Detecting, debugging, and fixing race conditions in concurrent code",
    difficulty: "advanced",
  ...
  "null-reference": {
    ...
    name: "Null Reference",
    description:
      "Understanding null/undefined, null safety, optional types, and defensive coding",
    difficulty: "intermediate",
    prerequisites: ["type-systems"],
  ...
  "type-mismatch": {
    ...
    name: "Type Mismatch",
    description:
      "Type checking, casting, coercion, and handling type incompatibilities",
    difficulty: "intermediate",
    prerequisites: ["type-systems"],
  ...
  "memory-leak": {
    ...
    name: "Memory Leak",
    description:
      "Detecting, preventing, and fixing memory leaks and resource leaks",
    difficulty: "intermediate",
 ...
 */
export function getPrerequisites(conceptId: string): Set<string> {
  const visited = new Set<string>();
  const prerequisites = new Set<string>();

  function visit(id: string) {
    if (visited.has(id) || !CONCEPT_GRAPH[id]) return;
    visited.add(id);
 ...
 */
export function generateGraphVisualization(): string {
  let output = "";
  ...
  // Group by difficulty
  const byDifficulty: Record<string, ConceptNode[]> = {
    beginner: [],
    intermediate: [],
    advanced: [],
  };
...
export function recommendNextConcept(
  ...
  for (const [conceptId, node] of Object.entries(CONCEPT_GRAPH)) {
    ...
    if (masteredConcepts.has(conceptId)) continue;
 ...
 */
export function generateMasteryReport(mastery: MasteryStatus[]): string {
  const masteredConcepts = new Set(
    mastery.filter((m) => m.mastered).map((m) => m.conceptId)
  );
  ...
  // Group by depth
  const byDepth: Record<string, MasteryStatus[]> = {
    surface: [],
    intermediate: [],
    deep: [],
  };
  ...
  // Gaps analysis
  const gapsConcepts: string[] = [];
  for (const [conceptId, node] of Object.entries(CONCEPT_GRAPH)) {
    if (masteredConcepts.has(conceptId)) continue;

    const prequisitesMet = node.prerequisites.every((p) =>
      masteredConcepts.has(p)
    );
    if (prequisitesMet) {
 ...
 * List all concepts
 */
export function listAllConcepts(): ConceptNode[] {
 ...
 */
export function searchConcepts(keyword: string): ConceptNode[] {
