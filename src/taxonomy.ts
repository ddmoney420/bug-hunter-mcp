 ...
 */
export const ISSUE_TAXONOMY: Record<string, IssueCategory> = {
  "race-condition": {
    id: "race-condition",
    name: "Race Condition",
    description:
      "Multiple threads/tasks accessing shared state without proper synchronization, leading to unpredictable behavior",
    keywords: ["concurrent", "threading", "race", "mutex", "lock", "sync"],
    strategies: [
      {
        name: "Add Logging with Timestamps",
        description:
          "Instrument code with detailed timestamps to track order of execution across threads",
        steps: [
      ...
      },
      {
        ...
        description:
          "Compile with thread sanitizer to detect data races at runtime",
        steps: [
  ...
  "memory-leak": {
    ...
    name: "Memory Leak",
    description:
      "Allocated memory that is no longer referenced but never freed, gradually exhausting available memory",
    keywords: ["memory", "leak", "malloc", "new", "allocate", "gc"],
    strategies: [
      {
        name: "Profile with Memory Debugger",
        description:
          "Use specialized memory profiling tools to track allocations and deallocations",
        steps: [
      ...
      },
      {
        ...
        description:
          "Verify RAII (C++), defer statements, or proper use of scope guards",
        steps: [
  ...
  "incorrect-logic": {
    ...
    description:
      "Algorithm or control flow produces wrong results; business logic errors or off-by-one mistakes",
    keywords: [
      "logic",
      "algorithm",
      "calculation",
    ...
    strategies: [
      ...
      },
      {
        ...
        description:
          "Insert assertions to verify invariants and log intermediate values",
        steps: [
  ...
  "api-incompatibility": {
    ...
    description:
      "Code uses API in a way that conflicts with its contract or expected behavior; version mismatches",
    keywords: [
      "api",
      "compatibility",
      "version",
  ...
  "type-mismatch": {
    ...
    name: "Type Mismatch",
    description:
      "Data of the wrong type passed to function or assigned to variable; casting errors",
    keywords: [
      "type",
      "mismatch",
      "cast",
    ...
    strategies: [
      ...
      },
      {
        ...
        description:
          "Explicitly declare expected types and verify at runtime if needed",
        steps: [
      ...
      },
      {
        ...
        description:
          "Follow data through transformations to identify where types diverge",
        steps: [
  ...
  "null-reference": {
    ...
    description:
      "Accessing property or method on null/undefined value; NullPointerException or TypeError",
    keywords: [
      "null",
      "undefined",
      "nil",
    ...
    strategies: [
      {
        ...
        description:
          "Insert defensive checks before accessing potentially null values",
        steps: [
      ...
      },
      {
        ...
        description:
          "Enable strict null checks in language/type checker to prevent nulls",
        steps: [
      ...
      },
      {
        ...
        description:
          "Verify objects are properly initialized before use throughout their lifecycle",
        steps: [
  ...
  "performance-bottleneck": {
    ...
    description:
      "Code runs too slowly; excessive memory, CPU, or I/O causing poor user experience",
    keywords: [
      "slow",
      "performance",
      "bottleneck",
    ...
    strategies: [
      {
        ...
        description:
          "Use profilers to identify hot spots consuming most time/memory",
        steps: [
  ...
  "encoding-error": {
    ...
    name: "Encoding Error",
    description:
      "Character encoding mismatch (UTF-8, ASCII, etc.); garbled text or deserialization failures",
    keywords: [
      "encoding",
      "charset",
      "unicode",
    ...
    strategies: [
      {
        ...
        description:
          "Check that data encoding is consistent across file, network, and memory",
        steps: [
      ...
      },
      {
        ...
        description:
          "Explicitly declare and convert between encodings as needed",
        steps: [
      ...
      },
      {
        ...
        description:
          "Exercise code with emoji, accents, and non-Latin scripts",
        steps: [
  ...
  "deadlock": {
    ...
    name: "Deadlock",
    description:
      "Two or more threads/processes waiting on each other, causing permanent hang; circular wait condition",
    keywords: ["deadlock", "hang", "blocked", "circular", "wait", "timeout"],
    strategies: [
      {
        name: "Visualize Lock Dependencies",
        description:
          "Map lock acquisition order and identify circular dependencies",
        steps: [
  ...
  "assertion-error": {
    ...
    description:
      "Assertion or assumption violated; invariant broken or precondition not met",
    ...
    strategies: [
      ...
      },
      {
        ...
        description:
          "Add defensive checks to validate function inputs match assumptions",
        steps: [
      ...
      },
      {
        ...
        description:
          "Check that objects and state remain consistent throughout operations",
        steps: [
 ...
 */
export function getStrategy(categoryId: string): IssueCategory | null {
 ...
 */
export function searchCategories(keyword: string): IssueCategory[] {
 ...
 */
export function suggestCategory(issueTitle: string, issueBody: string): string | null {
